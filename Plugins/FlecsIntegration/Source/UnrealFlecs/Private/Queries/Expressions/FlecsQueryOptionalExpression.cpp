...
#include "Queries/Expressions/FlecsQueryOptionalExpression.h"
...
void FFlecsQueryOptionalExpression::Apply(const TSolidNotNull<const UFlecsWorld*> InWorld, flecs::query_builder<>& InQueryBuilder) const
{
