    ...
    bool clear)
{
    ...
    ecs_os_perf_trace_push("flecs.table.move_bitset");
    ...
    ecs_os_perf_trace_pop("flecs.table.move_bitset");
}
    ...
    bool construct)
{
    ...
    ecs_os_perf_trace_push("flecs.table.grow_column");
...
{    
    ...
    ecs_os_perf_trace_push("flecs.table.swap");
