//
//  RTree.h
//  Original source from https://github.com/tuxalin/THST
//  Reused under the MIT license found in the repo as of 5/6/25
//  Investigate SPTree from FItSNE if needed.
//
...
#define TREE_QUAL                                                              \
  RTree<T, ValueType, Dimension, max_child_items, min_child_items,             \
	...
	// Search in an index tree or subtree for all data rectangles that overlap the
	// argument rectangle and stop at first node that is fully contained by the
	// bbox.
	TREE_TEMPLATE
		template <typename Predicate, typename OutIter>
