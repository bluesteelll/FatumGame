	...
	public FatumGame(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicIncludePaths.AddRange(
			new string[] {
				...
				"FatumGame/Melee/Public",
				"FatumGame/Melee/Public/Components",
				"FatumGame/Melee/Public/Library",
		...
		PrivateIncludePaths.AddRange(
			new string[] {
				...
				"FatumGame/Melee/Private",
				"FatumGame/Melee/Private/Components",
				"FatumGame/Melee/Private/Library",
				"FatumGame/Melee/Private/Systems",
